...
tests/
  ...
  test_parse_agent_output.py  -- 57 tests: envelopes, fenced/bare content, fail-closed recovery
...
| `test_parse_agent_output.py` | 57 | Envelope extraction (3 CLI formats), fence stripping, **bare content** (Ollama), embedded-verdict recovery and its fail-closed guards |
